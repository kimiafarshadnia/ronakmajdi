...
function RenderSubMenu({
  ...
  return (
    <ul className="bg-white rounded shadow-md mt-1 min-w-[200px]">
      {items.map((item) => (
  ...
  return (
    <header className="bg-background sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-row items-center justify-between">
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.nav
              ...
              className="fixed top-0 left-0 w-64 h-full bg-white shadow-lg z-50 p-6 overflow-y-auto md:hidden"
            >
              {/* Logo */}
        ...
        {/* Desktop Nav */}
        <nav className="hidden md:flex flex-row-reverse items-center justify-end gap-8 w-full max-w-7xl mx-auto px-4">
          ...
          {/* Logo */}
          <div className="flex justify-center items-center shrink-0 w-10 h-10">
            <Link href="/">
              <img
                src="/images/logo.svg"
